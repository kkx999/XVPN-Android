# XVPN Android v1.0.0-rc3 测试清单

## 源码与构建门槛

- [x] Application ID = `com.xvpn.android`
- [x] `versionName = 1.0.0-rc3`，`versionCode = 10020`
...
- [ ] `XVPN-v1.0.0-rc3.apk` 证书 SHA-256 与 `SIGNING_CERT_SHA256.txt` 一致
...
- [ ] 智能分流：国内域名与节点域名由直连 `223.5.5.5` UDP 解析，非国内域名由经代理的 Cloudflare DoH 解析
- [ ] 已连接时点击首页当前节点延迟徽章显示真实隧道延迟，不再误报“不可达”
- [ ] 全局代理：普通域名解析经代理 DoH；节点域名仍可通过独立直连引导解析建立连接
