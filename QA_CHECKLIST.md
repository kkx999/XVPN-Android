...
- [ ] 已连接状态点击其他 VLESS/Trojan/VMess/SS 节点卡片可得到与未连接时同量级的物理入口延迟，不出现 1–5 ms 假结果
...
- [ ] admin 登录也会启动流量上报；Panel 无统计字段时“我的”仍显示本机日 / 月 / 累计记录
- [ ] 连接成功后首页显示当前出口 IP；点击可查看运营商、机房 / 家宽和地区匹配说明并重新检测
