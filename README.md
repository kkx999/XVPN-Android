...
1.1.0 基于 RC5 真机结果统一连接前后测速、贯通自定义联网检测网站、恢复流量统计，并新增出口 IP 智能识别卡片；Application ID、固定签名链和 sing-box/libbox 1.13.19 数据面保持不变。发布 APK 前仍须完成 `QA_CHECKLIST.md` 的真机协议验收。
...
- CPU：1.1.0 仅包含 `arm64-v8a`，用于当前 arm64 Android 16 真机及同架构设备。
...
4. 下载 Artifact `XVPN-v1.1.0`，其中包含 APK 与 `SHA256SUMS.txt`。
